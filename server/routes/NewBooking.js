...
//   try {
//     if (!movie) {
//       return res.status(400).json({ ERROR: "Movies Name Required" });
//     }
//     if (!slot) {
...
//       req.body.seats.D2 === 0
//     ) {
//       return res.status(400).json({ ERROR: "Seat Required" });
//     }
...
//       })
//       .catch((err) => {
//         // If there's an error in saving to the database
...
//       });
//   } catch (error) {
//     return res.status(500).json(error); // This will show any error if it occurs.
//   }
// });
